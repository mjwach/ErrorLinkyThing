...
2) Find the regex that the plugin uses to identify line-in-file references.  This is stored in plugin.xml.  You can find it by poking around in the project in Eclipse, or by simply opening plugin.xml in a text editor.<br />
